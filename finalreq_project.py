...
def check_all_messages(message):
    ...
    response('Nice chatting with you. Goodbye!', ['stop'], single_response=True)
    ...
    response(long.R_Q1, ['do','you', 'have', 'name','what'], required_words=['name'])
...
print('Type [stop] if you want to end conversation.')
while True:
    user = input('You:')
